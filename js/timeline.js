  ...
  var Timeline = Widget.extend({
    ...
    _getDefaultTemplate: function() {
      return `# for (var i = 0; i < data.length; i++) { #
        ...
        <h1 id="timeline-header-#= data[i].date.getFullYear() #" style="font-size: 28px; text-align: center;">#= data[i].date.getFullYear() #</h1>
        <section id="cd-timeline" class="cd-container" style="margin-top: 0.5em;">
        # } #
